...
#include "main.h"
static const float Rs=5.5f/2 + 1*1.35f; //电机相电阻以及后面的板子导通电阻和采样电阻补偿项(Ohm)
static const float Ls= 2.e-3f/2 + 1*0.0004f; //电机相电感以及后面离线参数辨识得到的实际相电感(H)
 ...
 */
static const int32_t DeadTimeComp=34000*1.f/50/2;
